        ...
        <div className="container mx-auto px-4 py-16 md:py-24 max-w-4xl">
            ...
            <div className="prose prose-lg max-w-none text-slate-700">
                <p>
                    ...
                    un profesional, le sugerimos nuestro Kit de instalación, compuesto por:
                </p>
                ...
                <p className="mt-8">
                    <a href="https://wa.me/351910407785?text=Hola%2C%20quisiera%20saber%20m%C3%A1s%20sobre%20el%20Kit%20de%20Instalaci%C3%B3n">
